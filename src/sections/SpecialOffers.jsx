  ...
  return (
    <section className="flex flex-wrap items-center max-xl:flex-col-reverse gap-10 max-container">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <p className='mt-4 lg:max-w-lg info-text'>Embark on shopping journey that redefines your experience with unbeatable deals. From premier selections to incredible savings, we iffer unparalleled valut that sets us apart.</p>
